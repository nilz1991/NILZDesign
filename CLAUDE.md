...
## Working notes
- CSS cache-bust is currently at **`css/style.css?v=35`** — bump on the next CSS change (all HTML pages share the number). `js/components/footer.js?v=4` and the home page's `js/content.js?v=2` import are versioned too (JS is otherwise unversioned and caches hard).
