...
## Working notes
- CSS cache-bust is currently at **`css/style.css?v=34`** — bump on the next CSS change (all HTML pages share the number). `js/components/footer.js?v=4` is versioned too (JS is otherwise unversioned and caches hard).
